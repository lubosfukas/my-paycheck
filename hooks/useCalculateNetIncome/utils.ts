...
export const calculateEmployeeHealthInsurance = (
    ...
    to2Decimal(
        isSeverelyDisabled ? (grossIncome / 100) * 2 : (grossIncome / 100) * 4
    )
...
export const calculateIncomeTax = (taxBase: number, monthsWorked: number) => {
    ...
    return monthlyTaxBaseBeforeTax > livingWage176p8Multiply
