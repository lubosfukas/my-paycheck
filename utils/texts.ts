export const texts = {
    ...
    'otherCriteriaAccordion.label': 'Ďalšie kritéria',

    'childrenBelowSixInput.label': 'Deti pod 6 rokov (vrátane)',

    'childrenAboveSixInput.label': 'Deti nad 6 rokov',

    'monthsWorkedInput.label': 'Odpracované mesiace',

    'severelyDisabledSwitch.label': 'ZŤP',

    'companionIncomeInput.label': 'Nezdaniteľná časť na manželku/manžela',
    'companionIncomeInput.apply': 'Chcem uplatniť',
